...
##### Mysql 2 Mysql Sync #####
```
meepo.sync.source.type = DBSYNCBYIDSOURCE
meepo.sync.source.tableName = app_entity
meepo.sync.source.stepSize = 1000
meepo.sync.source.start = 10000
meepo.sync.source.datasource.url = jdbc:mysql://127.0.0.1:3306/test?rewriteBatchedStatements=true&amp;useUnicode=true&amp;characterEncoding=UTF-8
meepo.sync.source.datasource.username = root
meepo.sync.source.datasource.password = root

meepo.sync.channel.bufferSize = 16

meepo.sync.sink.type = DBINSERTSINK
meepo.sync.sink.tableName = app_entity2
meepo.sync.sink.stepSize = 1000
meepo.sync.sink.datasource.url = jdbc:mysql://127.0.0.1:3306/test?rewriteBatchedStatements=true&amp;useUnicode=true&amp;characterEncoding=UTF-8
meepo.sync.sink.datasource.username = root
meepo.sync.sink.datasource.password = root
```
